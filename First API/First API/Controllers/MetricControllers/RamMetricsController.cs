...
namespace First_API.Controllers
{
    ...
    public class RamMetricsController : ControllerBase
    {
        ...
        public static readonly string NameMetrics= "RamMetrics";
        ...
        public RamMetricsController(RamMetricsController @object)
        {
        ...
        public IActionResult Create([FromBody] RamMetricCreateRequest request)
        {
            ...
            logger.LogDebug(1, $"Добавлена RamMetric: {request.Name}") ;
            return Ok();
        }
        [HttpGet("all")]
        public IActionResult GetAll()
        {
            ...
            logger.LogDebug(1, $"Отправлены все RamMetric в {NameMetrics}");
            return Ok(response);
        }
    }
}
